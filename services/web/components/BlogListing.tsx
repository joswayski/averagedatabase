import { AspectRatio, Card, Container, Image, SimpleGrid, Text, Title, Badge, Group, Stack, Overlay, Box } from '@mantine/core';
  ...
  const cards = blogPosts.map((article) => (
    ...
    >
      <Box className="relative overflow-hidden">
        <AspectRatio ratio={16 / 9}>
          <div className="relative w-full h-full">
            ...
            />
            <div 
              className="absolute inset-0 bg-gradient-to-t from-black/75 to-transparent transition-opacity duration-300 group-hover:opacity-0"
            />
          </div>
        </AspectRatio>
      </Box>
      ...
      <Stack p="md" gap="xs">
        ...
        <Title order={3} className="font-['Outfit'] text-xl font-semibold text-gray-800">
          {article.title}
        </Title>
