...
curl -X POST https://averagedatabase.com/api/yeet \\
  ...
  "brought_to_you_by": "Tempur-Pedic: Experience the ultimate comfort with Tempur-Pedic mattresses."
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              are now stored on disk exactly as uploaded. We validate the
              filename extension, enforce a 10 MB limit per request, and then
              bravely leave the bytes alone.
            </p>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              approach. Files stop being available after three days. An hourly
              janitor deletes the bytes shortly afterward, which keeps our
              storage costs low and our compliance department unemployed.
            </p>
